...
@class FVPAbsolutePositionMessage;
...
@interface FVPAbsolutePositionMessage : NSObject
/// `init` unavailable to enforce nonnull fields, see the `make` class method.
- (instancetype)init NS_UNAVAILABLE;
+ (instancetype)makeWithTextureId:(NSInteger )textureId
...
/// @return `nil` only when `error != nil`.
- (nullable FVPAbsolutePositionMessage *)absolutePosition:(FVPTextureMessage *)msg error:(FlutterError *_Nullable *_Nonnull)error;
