...
abstract class TestHostVideoPlayerApi {
  ...
  static void setup(TestHostVideoPlayerApi? api,
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.AVFoundationVideoPlayerApi.absolutePosition',
          codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMockMessageHandler(null);
        ...
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.AVFoundationVideoPlayerApi.absolutePosition was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final TextureMessage? arg_msg = (args[0] as TextureMessage?);
          assert(arg_msg != null,
              'Argument for dev.flutter.pigeon.AVFoundationVideoPlayerApi.absolutePosition was null, expected non-null TextureMessage.');
          final AbsolutePositionMessage output = api.absolutePosition(arg_msg!);
          return <Object?, Object?>{'result': output};
        });
      }
    }
