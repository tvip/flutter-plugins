...
public class Messages {
  ...
  public static class AbsolutePositionMessage {
    ...
    /** Constructor is private to enforce null safety; use Builder. */
    private AbsolutePositionMessage() {}
    ...
    static @NonNull AbsolutePositionMessage fromMap(@NonNull Map<String, Object> map) {
  ...
  private static class AndroidVideoPlayerApiCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, ByteBuffer buffer) {
      switch (type) {
        case (byte) 128:
          return AbsolutePositionMessage.fromMap((Map<String, Object>) readValue(buffer));
    ...
    protected void writeValue(ByteArrayOutputStream stream, Object value) {
      if (value instanceof AbsolutePositionMessage) {
        stream.write(128);
        writeValue(stream, ((AbsolutePositionMessage) value).toMap());
